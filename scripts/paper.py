...
<style>
  ...
  .paper .byline a, .paper p a { color: var(--accent); text-decoration: underline; text-decoration-color: var(--hair-2); }
...
<div class="topbar"><a href="city3d.html">← the city</a><a href="https://github.com/Bereket-Belachew/four-mayors">source</a><a href="https://wandb.ai/betab-belachew1-fana-ai/coreweave-hacks/weave">Weave traces</a><a href="../docs/WORLD-RULES.md">the rules</a><a href="https://github.com/Bereket-Belachew/four-mayors/blob/master/docs/research/world-models.md">the research</a></div>
<article class="paper">
...
<p class="byline">Four Mayors · CoreWeave Hacks, San Francisco, 12–13 September 2026 · built solo · every number on this page is computed from <code>runs/demo-science.jsonl</code> by <code>scripts/paper.py</code> · the rules were checked against the literature in <a href="https://github.com/Bereket-Belachew/four-mayors/blob/master/docs/research/world-models.md">How our city compares with published city models</a></p>
